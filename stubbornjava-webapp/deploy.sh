...
ansible --vault-password-file ansible/.vault_pw.txt -i ansible/inventories/production stubbornjava -m copy -a "src=stubbornjava-webapp/build/libs/stubbornjava-all.jar dest=~/apps/stubbornjava" &&
